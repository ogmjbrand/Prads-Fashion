...
import { generateWhatsAppMessage, generateWhatsAppLink } from '@/utils/formatting';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="order-2 lg:order-1">
              {/* Main Image */}
              <div className="mb-4 bg-brand-cream rounded-lg overflow-hidden aspect-square flex items-center justify-center">
                <img
                  src={mainImage}
                  alt={product.name}
              ...
              <div className="grid grid-cols-4 gap-2">
                {product.images.map((image, index) => (
                  <button
                    ...
                    className={`bg-brand-cream rounded-lg overflow-hidden aspect-square border-2 transition-all ${
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                {relatedProducts.map((relatedProduct) => (
                  <div key={relatedProduct.id} className="cursor-pointer group">
                    <div className="mb-4 bg-brand-white rounded-lg overflow-hidden aspect-square">
                      <img
