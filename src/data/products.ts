...
// Photos supplied by Angel Anifowoshe (@angelina.anifowos on TikTok) of her
// handcrafted pieces. Prices have not been provided yet, so every item is
// price: null ("Price on Request") rather than a guessed number — update
// prices here once the owner confirms them, or connect this file to a real
// backend (e.g. Supabase) down the line.
