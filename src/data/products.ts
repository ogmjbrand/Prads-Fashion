...
export const products: Product[] = [
  {
    ...
    cutoutImage: '/products/flap-bag-rainbow-stripe-cutout.png',
    sizes: ['One Size'],
  ...
  },
  {
    ...
    cutoutImage: '/products/flap-bag-red-stripe-cutout.png',
    sizes: ['One Size'],
    colors: ['Red Stripe'],
    inStock: true,
    featured: true,
  ...
  },
  {
    ...
    cutoutImage: '/products/flap-bag-yellow-croc-cutout.png',
    sizes: ['One Size'],
    colors: ['Yellow Croc'],
    inStock: true,
    featured: true,
  },
  {
    ...
    cutoutImage: '/products/top-handle-espresso-cutout.png',
    sizes: ['One Size'],
